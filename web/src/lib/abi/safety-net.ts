// Generated from out/SafetyNet.sol/SafetyNet.json — do not edit by hand.
...
export const safetyNetAbi = [
  ...
  {
    "type": "function",
    "name": "createRequestWithSignature",
    "inputs": [
      {
        "name": "_request",
        "type": "tuple",
    ...
    "outputs": [
      {
        "name": "_dashboard",
        "type": "tuple[]",
        "internalType": "struct ISafetyNet.SafetyNetDetails[]",
        "components": [
          {
            "name": "safetyNet",
            "type": "tuple",
          ...
          },
          {
            "name": "requests",
            "type": "tuple[]",
            "internalType": "struct ISafetyNet.RequestView[]",
            "components": [
              {
                "name": "id",
                "type": "uint256",
